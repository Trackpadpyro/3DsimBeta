...
//Lorenz chaos system coordinates, trail size is how far it trails, runl is whether or not to run it, stepsize is how large differentials are, the rest are the usual parameters and initial conditions
int trailsize = 100;
bool runl = 0;
